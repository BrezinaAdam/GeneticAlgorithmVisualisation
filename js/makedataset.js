...
function getFormulars()
{
	...
	root = document.getElementById("synapse").getElementsByTagName("input");
	counter = 0;
	...
	for (var i = 0; i < 5; i++)
	{
		...
		weights_biases[0][i][0] = root[counter++];
		weights_biases[0][i][1] = root[counter++];
	...
	for (i = 0; i < 6; i++)
	{
		weights_biases[1][i] = root[counter++];
